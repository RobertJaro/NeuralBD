...
from nbd.nbd_integration import NeuralBDIntModule
...
if __name__ == '__main__':
    ...
    def save(*args, **kwargs):
        torch.save({
            'p_model': neuralbd.p_model,
            'g_model': neuralbd.g_model,
            'object_model': neuralbd.object_model,
